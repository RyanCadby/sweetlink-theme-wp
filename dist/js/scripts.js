...
jQuery(function ($) {
  $(window).on('load', function () {
    ...
    console.log($('html').width()); // $('.p-sweet:first-of-type').css('font-size', sweet_font_size + 'vw');
    // Sweet font sizes
    ...
    $(document).scroll(function () {
      ...
      sweet.each(function () {
        ...
        bottom_of_screen = curr_scroll + window_height;
        bottom_of_target = target_position + target_height;
        target_percentage_position = Math.floor((bottom_of_screen - bottom_of_target) / (window_height - window_height * .6) * 400); // console.log('bottom of screen: ' + bottom_of_screen);
